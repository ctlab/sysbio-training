...
## ----ig.show = 'hold', fig.width=7, fig.height=3, fig.fullwidth=T, dev='svg'----

pheatmap(someGenes, color=blueWhiteRed, annotation_col = pData(gse129260), cluster_cols = F)



## ----ig.show = 'hold', fig.width=7, fig.height=4, fig.fullwidth=T, dev='svg'----
...
## ----fig.show = 'hold', fig.width=5, fig.height=3, fig.fullwidth=T, dev='svg'----
...
## ----fig.show = 'hold', fig.width=6, fig.height=3, fig.fullwidth=T, dev='svg'----
...
colnames(model_simple) <- c("Intercept", "Positive")
model_simple
...
## ----fig.show = 'hold', fig.width=5, fig.height=3.5, fig.fullwidth=T, dev='svg'----
...
## ----fig.show = 'hold', fig.width=8, fig.height=3.5, fig.fullwidth=T, dev='svg'----
...
## ----fig.show = 'hold', fig.width=8, fig.height=3, fig.fullwidth=T, dev='svg'----
stats <- de$t
...
plotEnrichment(keggSymbolMouse[["Spliceosome - Mus musculus (mouse)"]], stats)
...
## ----fig.show = 'hold', fig.width=10, fig.height=3.5, fig.fullwidth=T, dev='svg'----
...
## ----fig.show = 'hold', fig.width=10, fig.height=4, fig.fullwidth=T, dev='svg'----
dev.off()
